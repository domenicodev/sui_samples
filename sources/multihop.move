...
module sample::multihop {
    ...
    public fun start_multihop_chain(obj: MyObject, name: vector<u8>, recipient: address) {
    ...
    public fun create_and_start_chain(name: vector<u8>, recipient: address, ctx: &mut sui::tx_context::TxContext) {
...
module sample::set_name {
    ...
    public fun set_name(obj: MyObject, name: vector<u8>, recipient: address) {
        let mut obj = obj;
    ...
    public fun create_and_process(name: vector<u8>, recipient: address, ctx: &mut sui::tx_context::TxContext) {
        let obj = types::new_my_object(ctx);
...
module sample::set_surname {
    ...
    public fun set_surname_entry(obj: MyObject, surname: vector<u8>, recipient: address) {
...
module sample::set_address {
    ...
    /// Entry function version
    public fun set_address_entry(obj: MyObject, address: vector<u8>, recipient: address) {
